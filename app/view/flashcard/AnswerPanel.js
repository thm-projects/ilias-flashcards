/*--------------------------------------------------------------------------------+
  - Dateiname:		app/view/flashcard/AnswerPanel.js
...
Ext.define('LearningApp.view.flashcard.AnswerPanel', {
    extend: 'Ext.Panel',
    xtype: 'answerPanel',
    ...
    initialize: function() {
            ...
            handler: function() {
                ...
                if(!answerPanel.config.testMode) {                    
                    if(answerPanel.evaluationObj.rate >= 0.7) {
                        ...
                        LearningApp.app.main.navigation.getActiveItem().mask();
                    ...
                    var index = LearningApp.app.main.cardCarousel.getActiveIndex() + 1,
                        statObj = LearningApp.app.main.cardCarousel.statisticObject,
                        reachedPoints = answerPanel.evaluationObj.reachedPoints;
                    
                    statObj[index].reachedPoints = parseFloat(reachedPoints);
                    LearningApp.app.getController('AnswerController').disableActiveItemInCarousel();
        ...
        this.onBefore('painted', function() {
            LearningApp.app.main.navigation.getNavigationBar().getBackButton().hide();
            LearningApp.app.main.tabPanel.getTabBar().add(this.saveButton);
            LearningApp.app.main.tabPanel.hideAllTabs();
        });
        ...
        this.onBefore('destroy', function() {
            ...
            LearningApp.app.main.navigation.getNavigationBar().getBackButton().show();
            
            /** destroy loadingmask and restore saved animation */
            LearningApp.app.main.navigation.getLayout().setAnimation(
                LearningApp.app.main.navigation.getSavedAnimation()
            );
    ...
    saveAnswer: function(boxId, promise) {
        LearningApp.app.getController('AnswerController').saveAnswerToDatabase(
